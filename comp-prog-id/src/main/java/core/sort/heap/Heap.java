...
public class Heap {
	...
	public static void removeRoot(Comparable[] pq) {
		pq[0] = Integer.MIN_VALUE;
		sink(pq, 1, pq.length);
	}
	
	public static void removeRoot(Comparable[] pq, int indexToRem, int n) {
		exch(pq, indexToRem, n);
		sink(pq, indexToRem, n-1);
	}

	public static void insert(Comparable[] pq, int elem, int n) {
		pq[n - 1] = elem;
		int down = n;
		int top = down / 2;
		while (top != 0) {
	...
	public static void main(String[] args) {
		/*
		 * String[] a = StdIn.readAllStrings(); Heap.sort(a); show(a); assert
		 * isSorted(a);
		 */
		/*
		 * Integer[] a = new Integer[] { 3, 2, 4, 6, 5, 1 }; Heap.sink(a, 1,
		 * a.length); System.out.println(Arrays.toString(a));
		 */
